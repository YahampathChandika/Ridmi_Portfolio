    ...
    <div id="features" className="py-16 px-4 sm:px-8 bg-gray-100">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-16">
        {features.map((feature) => (
          <div
            key={feature.id}
            className="bg-gradient-to-br from-black/30 to-white/10 shadow-2xl text-wht/80 md:px-8 md:py-12 px-6 py-10 flex flex-col justify-around rounded-lg transition-all duration-300 hover:shadow-xl hover:scale-105 hover:bg-gradient-to-br hover:from-pnk hover:to-red-600 group cursor-pointer"
          >
            <i
